...
function SingleRatingRate({
  ...
  return (
    <div className="__single-rating flex items-center space-x-2">
    ...
    <div className="container sm:grid sm:grid-cols-5 sm:space-x-14 bg-white rounded-md border-t border-gray-200 py-5">
      <div className="__left sm:col-span-2 space-y-8">
        <div className="__summary-wrp flex-col space-y-4">
          ...
          <div className="__rating-statistics flex-col space-y-3">
      ...
      <div className="__right sm:col-span-3 divide-y flex-col overflow-y-scroll space-y-7 sm:max-h-[400px] mt-8 sm:mt-0">
        <div className="pt-5">
